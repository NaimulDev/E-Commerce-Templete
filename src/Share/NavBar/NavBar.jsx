...
const NavBar = () => {
  ...
  return (
    <>
      <div className="px-4 pt-5  px-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  font-bold">
        <div className="relative flex items-center justify-between">
          ...
          <div className="form-control relative">
            <input
              type="text"
              placeholder="Search"
              className="input input-bordered w-24 md:w-96 md:h-7 rounded-full"
            />
